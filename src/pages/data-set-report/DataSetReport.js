...
export default class DataSetReport extends Page {
    ...
    getReport = () => {
        ...
        const dataSetOptions = Object.keys(
            this.state.selectedOptionsForDimensions
        ).map(
            dimensionKey =>
                `${dimensionKey}:${
                    this.state.selectedOptionsForDimensions[dimensionKey]
                }`
        )
        const orgUnitGroupsOptions = Object.keys(
        ...
        }&ou=${this.state.selectedOrgUnit}&selectedUnitOnly=${
            this.state.selectedUnitOnly
            ...
            >
                {i18n.t(
                    this.state.showOptions
                        ? i18nKeys.dataSetReport.showFewOptions
                        : i18nKeys.dataSetReport.showMoreOptions
                )}
            </span>
            <div
                id="extra-options"
