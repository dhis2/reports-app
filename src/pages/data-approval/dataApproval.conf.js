...
export const isReadyForApprove = approvalInfo =>
    FOR_APPROVE_STATUS.includes(approvalInfo.status) && approvalInfo.mayApprove

export const isReadyForUnapprove = approvalInfo =>
    FOR_UNAPPROVE_STATUS.includes(approvalInfo.status) &&
    approvalInfo.mayUnapprove

export const isReadyForAcceptance = approvalInfo =>
    FOR_ACCEPTANCE_STATUS.includes(approvalInfo.status) &&
    approvalInfo.mayAccept

export const isReadyForUnacceptance = approvalInfo =>
    FOR_UNACCEPTANCE_STATUS.includes(approvalInfo.status) &&
    approvalInfo.mayUnaccept
