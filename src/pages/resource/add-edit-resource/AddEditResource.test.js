...
describe('Test <AddEditResource /> rendering:', () => {
    ...
    beforeEach(() => {
        wrapper = ownShallow({
            selectedResource: { resource: 'ResourceName', id: 'ResourceId' },
        })
    ...
    it('Should display report "name" input with correct value.', () => {
        ...
        expect(dialog.find('[name="resourceName"]').props().value).toBe(
            mockResource.name
        )
    })
    ...
    it('Should display "type" selector with correct value.', () => {
        ...
        expect(dialog.find('[name="resourceType"]').props().value).toBe(
            mockResource.type
        )
    })
    ...
    it('Should display "resourceAttachment" checkbox.', () => {
        ...
        expect(dialog.find('#resourceAttachment').props().checked).toBe(
            mockResource.attachment
        )
    })
    ...
    it('Should allow to insert an external URL to the resource "EXTERNAL_URL".', () => {
        ...
        expect(dialog.find('[name="resourceUrl"]').props().value).toBe(
            mockResource.url
        )
    })
...
describe('Test <AddEditResource /> actions:', () => {
    ...
    it('Should return correct types to resource type selection.', () => {
        ...
        expect(type).toEqual([
            { id: 'EXTERNAL_URL', name: 'External URL', external: true },
        ])
    })
