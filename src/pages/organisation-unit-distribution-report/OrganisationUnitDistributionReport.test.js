...
describe('Test <OrganisationUnitDistributionReport /> rendering:', () => {
    ...
    it('Should display form', () => {
        expect(wrapper.find('#org-unit-dist-report-form').props().style.display).toBe('block');
    });
    ...
    it('Should display no form when showForm is false', () => {
        ...
        expect(wrapper.find('#org-unit-dist-report-form').props().style.display).toBe('none');
    });
